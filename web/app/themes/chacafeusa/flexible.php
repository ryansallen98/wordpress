...
// Resolve view: resources/views/acf-sections/{slug}.blade.php
$view_name = "acf-sections.$slug";
...
if (function_exists('\Roots\view')) {
  ...
  $php_fallback = get_stylesheet_directory() . "/resources/views/acf-sections/{$slug}.php";
